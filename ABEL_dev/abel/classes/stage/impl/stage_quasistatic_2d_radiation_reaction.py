...
class StageQuasistatic2dRadiationReaction(Stage):
    
    def __init__(self, length=None, nom_energy_gain=None, plasma_density=None, driver_source=None, add_driver_to_beam=False, enable_rr = True):
